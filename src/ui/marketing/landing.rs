...
pub fn LandingPage() -> impl IntoView {
    view! {
        <div class="min-h-screen bg-gray-50">
            // Hero Section
            <div class="bg-white">
                <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center animate-rise-in motion-reduce:animate-none">
            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    // API Key Management
                    <div class="bg-white rounded-lg shadow p-6 animate-rise-in motion-reduce:animate-none" style="animation-delay: 60ms">
                    ...
                    // Rate Limiting
                    <div class="bg-white rounded-lg shadow p-6 animate-rise-in motion-reduce:animate-none" style="animation-delay: 120ms">
                    ...
                    // Subscription Tiers
                    <div class="bg-white rounded-lg shadow p-6 animate-rise-in motion-reduce:animate-none" style="animation-delay: 180ms">
